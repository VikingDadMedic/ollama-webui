---
title: Prompts
source: features/workspace/prompts/index.html
word_count: 2098
code_blocks: 0
quality_score: 65.0
extracted: 2025-12-14T09:48:31.712095
---
 ...
 * **Prompt Content:**
[code] Please summarize the following article. {{article_text | textarea:placeholder="Paste the full text of the article here...":required}} 
 ...
 * **Prompt Content:**
[code] Generate a bug report with the following details: 
 ...
 * **Prompt Content:**
[code] Generate a social media post for {{platform | select:options=["LinkedIn","Twitter","Facebook","Instagram"]:required}}. 
 ...
 * **Prompt Content:**
[code] Please review the following {{content_type | select:options=["Blog Post","Marketing Copy","Documentation","Email","Presentation"]:required}}: 
