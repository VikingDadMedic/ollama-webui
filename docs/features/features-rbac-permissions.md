---
title: Permissions
source: features/rbac/permissions/index.html
word_count: 548
code_blocks: 0
quality_score: 65.0
extracted: 2025-12-14T09:48:31.450061
---
 ...
 * **Tools Access** : Toggle to allow users to access and manage tools. (Environment variable: `USER_PERMISSIONS_WORKSPACE_TOOLS_ACCESS`) _Note: Enabling this gives users the ability to upload arbitrary code to the server._
