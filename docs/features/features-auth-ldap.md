...
source: features/auth/ldap/index.html
word_count: 1062
code_blocks: 0
quality_score: 65.0
extracted: 2025-12-14T09:48:30.072847
---
...
[code] ldapwhoami -x -H ldap://localhost:389 \ 
...
[code]dn: uid=jdoe,ou=users,dc=example,dc=org 
 changetype: modify 
...
Apply it with:
[code] docker exec openldap ldapmodify -x -D "cn=admin,dc=example,dc=org" -w admin -f /path/to/change_password.ldif 
