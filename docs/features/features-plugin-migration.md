...
source: features/plugin/migration/index.html
word_count: 1136
code_blocks: 0
quality_score: 75.0
extracted: 2025-12-14T09:48:30.896004
---
 ...
 * For example: 
 * **Before (0.4):**
[code] from open_webui.apps.webui.models import SomeModel 

[/code]

 * **After (0.5):**
[code] from open_webui.models import SomeModel 
