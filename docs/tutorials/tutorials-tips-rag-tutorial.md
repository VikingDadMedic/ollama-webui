...
source: tutorials/tips/rag-tutorial/index.html
word_count: 516
code_blocks: 0
quality_score: 65.0
extracted: 2025-12-14T09:48:33.478986
---
 ...
 * Navigate to **New Chat** and select the `Open WebUI` model.
 2. **Example Queries** :
[code] User: "How do I configure environment variables?" 
 System: "Refer to Section 3.2: Use the `.env` file to manage configurations." 

[/code]
[code] User: "How do I update Open WebUI using Docker?" 
