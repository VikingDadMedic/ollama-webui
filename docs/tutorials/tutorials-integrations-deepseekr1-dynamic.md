...
source: tutorials/integrations/deepseekr1-dynamic/index.html
word_count: 1036
code_blocks: 0
quality_score: 80.0
extracted: 2025-12-14T09:48:33.127809
---
...
[code] cd [path-to-llama-cpp]/llama.cpp/build/bin 

[/code]

Replace `[path-to-llama-cpp]` with the location where you cloned or built Llama.cpp. For example:
[code] cd ~/Documents/workspace/llama.cpp/build/bin 
