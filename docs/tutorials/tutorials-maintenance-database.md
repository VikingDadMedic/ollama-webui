...
source: tutorials/maintenance/database/index.html
word_count: 514
code_blocks: 0
quality_score: 75.0
extracted: 2025-12-14T09:48:33.393409
---
...
[code] docker cp open-webui:/app/backend/data/webui.db ./webui.db 
...
[code] docker cp ./webui.db open-webui:/app/backend/data/webui.db 

[/code]

 3. **Start the Open WebUI container** : Start the container again to use the imported database.
[code] docker start open-webui 
