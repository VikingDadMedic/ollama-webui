---
title: Ready to Contribute to Open WebUI? Let's Get Started! 🚀
source: getting-started/advanced-topics/development/index.html
word_count: 3390
code_blocks: 0
quality_score: 75.0
extracted: 2025-12-14T09:48:31.742198
---
...
[code] # If you are not in the project root, run: 
 cd open-webui 
...
[code] conda create --name open-webui python=3.11 
...
[code] pip install -r requirements.txt -U 
...
[code] export CORS_ALLOW_ORIGIN="http://localhost:5173;http://localhost:8080;http://192.168.1.42:5173" 
...
[code] export NODE_OPTIONS="--max-old-space-size=4096" # For Linux/macOS (bash, zsh) 
