---
title: API Endpoints
source: getting-started/api-endpoints/index.html
word_count: 1056
code_blocks: 0
quality_score: 75.0
extracted: 2025-12-14T09:48:31.849499
---
 ...
 * **Example** :
[code] curl -H "Authorization: Bearer YOUR_API_KEY" http://localhost:3000/api/models 
 ...
 * **Curl Example** :
[code] curl -X POST http://localhost:3000/api/chat/completions \ 
 ...
 * **Curl Example** :
[code] curl -X POST -H "Authorization: Bearer YOUR_API_KEY" -H "Accept: application/json" \ 
 ...
 * **Curl Example** :
[code] curl -X POST http://localhost:3000/api/v1/knowledge/{knowledge_id}/file/add \ 
 -H "Authorization: Bearer YOUR_API_KEY" \ 
 -H "Content-Type: application/json" \ 
