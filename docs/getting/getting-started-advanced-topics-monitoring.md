---
title: Keep Your Open WebUI Healthy with Monitoring 🩺
source: getting-started/advanced-topics/monitoring/index.html
word_count: 1351
code_blocks: 0
quality_score: 80.0
extracted: 2025-12-14T09:48:31.785448
---
...
_(Optional but Recommended):_ For security best practices, consider creating a **non-administrator user account** specifically for monitoring and generate an API key for that user. This limits the potential impact if the monitoring API key is compromised.

_If you don't see the API key generation option in your settings, contact your Open WebUI administrator to ensure API keys are enabled._
